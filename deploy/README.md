...
| `CORS_ORIGIN`           | no     | no             | `https://<web public domain>`. The SPA is a separate origin (DESIGN.md §7). |
...
cross-service schema changes are expand/contract and are applied deliberately (DESIGN.md §9).
