 ...
 * Personal concerns only: party mode moved to the game toolbar's Share popover (owner ruling,
 * docs/design/room-actions-control.md R3 — the projector is the room's reach, not an account
 * setting). */
      ...
      <div className="sidebar-dissolve flex w-[calc(var(--sidebar-width)-24px)] items-center justify-between gap-2 rounded-4 border border-border bg-panel p-3 shadow-sm group-data-[collapsible=icon]:invisible group-data-[collapsible=icon]:opacity-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-52">
            <AccountMenu onSignOut={onSignOut} onSettings={onSettings} />
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
