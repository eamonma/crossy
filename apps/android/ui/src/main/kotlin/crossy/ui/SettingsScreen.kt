...
/** A legal page the screen can ask the composition root to open (the WelcomeScreen grammar): the
 *  screen signals intent, :app maps it to the live URL and opens a Custom Tab (App Review 5.1.1: the
 *  person stays in the flow). :ui names no URL. */
